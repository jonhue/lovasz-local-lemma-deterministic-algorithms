...
\RenewDocumentCommand{\Pr}{m}{Pr[#1]}
...
\input{figures/resampling_table}
\end{column}\pause
\begin{column}{.2\textwidth}
...
\begin{frame}{Outline}
    ...
    \begin{enumerate}
        \item Construct set of unlikely resamples of randomized MT algorithm.
        \item Use method of conditional expectations to find a resampling table $R$ such that all of these resamplings are avoided.
