...
\date{March 29, 2022}
%   \def\beamer@sortzero##1{\beamer@ifnextcharospec{\beamer@sortzer
...
\end{frame}
\subsection{The Structure of the Resampling Table and Witness DAGs}
...
\tableofcontents[currentsection, sectionstyle=show/shaded, hideothersubsections]
\end{frame}
\subsection{Collectible Witness DAGs}
\begin{frame}{Frame Title}
